...
urlpatterns = [
    ...
    re_path(r'^dll/', views.ViewLogs.as_view(), name='dll'),
    ...
    path('acknowledge/<str:checkout_id>/<str:merchant_id>/<str:amount>/', views.Acknowledge.as_view(), name='acknowledge'),
    path('post_ack/', views.Acknowledge.as_view(), name='post_ack'),
    path('open/', views.OpenAPI.as_view(), name='open'),
    re_path(r'^mockapi/(?P<pk>[\w-]+)/$', views.MockAPI.as_view(), name='mock'),
